    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?=base_url();?>index.php" class="navbar-brand"><b>OTAKU</b>Perpustakaan</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="<?=base_url();?>index.php"> <i class="glyphicon glyphicon-home"></i> Home </a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?=site_url('anggota');?>">Daftar Angota</a></li>
                <li class="divider"></li>
